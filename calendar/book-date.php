...
<html lang="en">
  ...
  <div class="py-5 text-center">
    ...
    <p class="lead"></p>
      ...
      <form class="needs-validation" action = "./scripts/book-slot.php" method = "POST" novalidate>
        <div class="row">
        ...
        <div class="mb-3">
          ...
          <div class="invalid-feedback">
            Please enter number of rooms required
          </div>
        </div>
        ...
        <div class="d-block my-3">
          <div class="custom-control custom-radio">
            <input id="credit" name="payment" value = "cash" type="radio" class="custom-control-input" checked required>
        ...
        <hr class="mb-4">
        <button class="ui primary button" type="submit">Continue to checkout</button>
      </form>
    </div>
  </div>
